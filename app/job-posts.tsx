...
export default function JobPosts() {
            ...
            const mockJobs: JobPost[] = [
                {
                    ...
                    description: 'Looking for skilled construction worker for residential project. Must have experience with concrete work and basic tools.',
                ...
                },
                {
                    ...
                    description: 'Need plumbing assistant for commercial project. Training will be provided for the right candidate.',
                    location: 'Delhi, NCR',
                ...
                },
                {
                    ...
                    description: 'Urgent requirement for electrician for wiring work in new building.',
    ...
    const handleCreateJob = async () => {
        if (!newJob.title || !newJob.description || !newJob.location || !newJob.wage) {
    ...
    const toggleJobStatus = (jobId: string, currentStatus: string) => {
        ...
        setJobPosts(prev => prev.map(job =>
            job.id === jobId ? { ...job, status: newStatus as 'active' | 'paused' | 'closed' } : job
        ));
    };
                    ...
                    {jobPosts.map((job) => (
                        <View key={job.id} style={styles.jobCard}>
                            ...
                            <View style={styles.jobDetails}>
                                ...
                                <Text style={styles.jobDetail}>📞 {job.contactMethod} - {job.contactPrice}</Text>
                            </View>
                        ...
                        <ScrollView style={styles.modalForm}>
                                ...
                                <View style={styles.workTypeContainer}>
                                    {['Skilled', 'Semi-skilled', 'Unskilled'].map((type) => (
                                        ...
                                        >
                                            <Text style={[
                                                styles.workTypeText,
                                                newJob.workType === type && styles.workTypeTextSelected
                                            ]}>
                                                {type}
                                            </Text>
                                        </TouchableOpacity>
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) => setNewJob({ ...newJob, experience: text })}
                                />
                            </View>
                                ...
                                <View style={styles.contactMethodContainer}>
                                    <TouchableOpacity
                                        style={[
                                            ...
                                            newJob.contactMethod === 'call' && styles.contactMethodSelected
                                        ]}
                                        onPress={() => setNewJob({ ...newJob, contactMethod: 'call' })}
                                    >
                                        <Text style={[
                                            styles.contactMethodText,
                                            newJob.contactMethod === 'call' && styles.contactMethodTextSelected
                                        ]}>
                                            Call
                                        </Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity
                                        style={[
                                            styles.contactMethodOption,
                                            newJob.contactMethod === 'text' && styles.contactMethodSelected
                                        ]}
                                        onPress={() => setNewJob({ ...newJob, contactMethod: 'text' })}
                                    >
                                        <Text style={[
                                            styles.contactMethodText,
                                            newJob.contactMethod === 'text' && styles.contactMethodTextSelected
                                        ]}>
                                            Text
                                        </Text>
                                    </TouchableOpacity>
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) => setNewJob({ ...newJob, contactPrice: text })}
