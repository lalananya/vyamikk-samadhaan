        ...
        try {
            ...
            const mockJobs: JobPost[] = [
                ...
                },
                {
                    id: '4',
                    title: 'Painting Work',
                    description: 'Need experienced painter for house painting project. Must have own tools.',
                ...
                [
                    { text: "Cancel", style: "cancel" },
                    {
                        ...
                        onPress: () => {
                            ...
                            Alert.alert("Success", `Contacting ${selectedJob.employer} via ${selectedJob.contactMethod}`);
                    ...
                    {filteredJobs.map((job) => (
                        <View key={job.id} style={styles.jobCard}>
                            ...
                            <View style={styles.jobDetails}>
                                ...
                                <Text style={styles.jobDetail}>👥 {job.applications} applications</Text>
                            </View>
                                ...
                                <View style={styles.workTypeContainer}>
                                    {['Skilled', 'Semi-skilled', 'Unskilled'].map((type) => (
                                        ...
                                        >
                                            <Text style={[
                                                styles.workTypeText,
                                                filters.workType === type && styles.workTypeTextSelected
                                            ]}>
                                                {type}
                                            </Text>
                                        </TouchableOpacity>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        {selectedJob && (
                            <View style={styles.contactInfo}>
                                ...
                                <Text style={styles.contactEmployer}>by {selectedJob.employer}</Text>
